...
For current advice, read [Getting started: normal mode and Hardcore](/wiki/getting-started/#normal-mode-and-hardcore). This post describes the mode's original release.
